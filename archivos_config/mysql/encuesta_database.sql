...
--
-- Host: localhost    Database: bdencuesta
-- ------------------------------------------------------
...
INSERT INTO `lime_settings_global` VALUES ('DBVersion','178'),('SessionName',')I$\\V\\2a]{PEL\'_9@|9tPoq3D[C:L09TX<20xCqV?B{kI\\%iZ>^,/P>S-alXq\'.K'),('sitename','Encuestas'),('siteadminname','Administrator'),('siteadminemail','soporte@iered.org'),('siteadminbounce','soporte@iered.org'),('defaultlang','es'),('updateversions','[]'),('updateavailable','0'),('updatelastcheck','2015-02-17 11:29:38');
...
INSERT INTO `lime_users` VALUES (1,'admin','220fa19b8dd8daea354278a861a8cafc301020d3d394667224d6c9cda8891feb','Administrator',0,'es','soporte@iered.org','default','default','default',NULL,1,'2015-02-17 11:28:52','2015-02-17 11:31:06');
...
-- Dump completed on 2015-02-17 11:44:33

...
#4) copiar las apps a su ubicacion correspondiente
	...
	#4.6) kiwix - wikipedia
		...
		cp /media/servidor/UUI/recursos/kiwix-0.9-rc2+wikipedia_es_all_nopic_02_2014.zip /var/www/html/kiwix-0.9-rc2+wikipedia_es_all_nopic_02_2014
		cd /var/www/html/kiwix-0.9-rc2+wikipedia_es_all_nopic_02_2014
		unzip kiwix-0.9-rc2+wikipedia_es_all_nopic_02_2014.zip
		chown servidor.servidor /var/www/html/kiwix-0.9-rc2+wikipedia_es_all_nopic_02_2014 -R
		...
		## cp scripts/start_kiwix.sh /home/servidor/Escritorio
		## chmod ugo+rx /home/servidor/Escritorio/start_kiwix.sh

	#4.7) Archivos
		echo "COPIANDO Y CONFIGURANDO ARCHIVOS ..."
		mkdir /var/www/html/archivos
		chown servidor.servidor /var/www/html/archivos/ -R
		ln -s /var/www/html/archivos/ /home/servidor/Escritorio
		

	#4.8) REA en archivos
		echo "COPIANDO Y CONFIGURANDO REA ..."
		cp /media/servidor/UUI/recursos/REA_v2.zip /var/www/html/archivos
		cd /var/www/html/archivos
		unzip REA_v2.zip
		chown servidor.servidor /var/www/html/archivos/REA -R
